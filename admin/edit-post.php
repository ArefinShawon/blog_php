...
$result = $post->getPostInfoById($_GET['id']);
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="long_desc" class="form-control" rows="6"><?php echo $postInfo['long_desc'] ?></textarea>
                        </div>
                        <div class="form-group">
                            <label>Post Image</label>
                            <input type="file" name="post_image" class="form-control-file">
                            <img src="<?php echo $postInfo['post_image'] ?>" width="200">
                        </div>
                        <div class="form-group">
